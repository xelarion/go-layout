...
const (
	...
	CodeUserDisabled   = 1002 // User account is disabled
	CodeForbidden      = 1003 // Permission denied (no access rights)
	CodeValidation     = 1004 // Input validation failed
	CodeNotFound       = 1005 // Resource not found
	CodeDuplicate      = 1006 // Resource already exists (duplicate)
	CodeRequestTimeout = 1007 // Request timeout
